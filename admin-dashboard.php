...
?>
    <div class="container-fluid py-4">
      <div class="row">
        <?php require 'inc/admindashboardcards.inc.php'; ?>
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <h4 class="mb-0"><?php echo $admintotalcount; ?></h4>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <h4 class="mb-0"><?php echo $adminpendingcount; ?></h4>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <h4 class="mb-0"><?php echo $adminacceptedcount; ?></h4>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <h4 class="mb-0"><?php echo $adminrejectedcount; ?></h4>
              </div>
            </div>
          </div>
        </div>
