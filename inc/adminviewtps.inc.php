<?php
$sql2 = "SELECT * FROM tps_applications  WHERE appnumber = '$appnumber' AND username = '$username'";
...
?>
<div class="container">
  <div style="border-style:solid; border-width:2px; border-radius:5px; margin-top:20px; margin-bottom:20px;">
    <div class="row">
...
<div class="container">
  <form>
    ...
    <div class="row">
      <div class="col-lg-12">
        <p>Why do you want to join Toronto Police? (50 Word Minimum)</p>
        <div class="input-group input-group-outline my-3">
    ...
    <div class="row">
      <div class="col-lg-12">
        <p>What are your duties as Police in Canada?</p>
        <div class="input-group input-group-outline my-3">
    ...
    <div class="row">
      <div class="col-lg-12">
        <p>What do you have to offer to Toronto Police?</p>
        <div class="input-group input-group-outline my-3">
    ...
    <div class="row">
      <div class="col-lg-12">
        <p>What makes you suitable for this department? (40 Word Minimum)</p>
        <div class="input-group input-group-outline my-3">
